...
@Component({
  selector: 'app-user-qa-edit',
  templateUrl: './user-qa-edit.component.html',
  styleUrls: ['./user-qa-edit.component.scss']
})
export class UserQaEditComponent implements OnInit {
  ...
  detailUser(){
    ...
    this.UserQaService.detailProjectManager(data).then(restData => {
  ...
  onSubmit(form: NgForm){
    ...
    if (this.json_locstor !== null) {
      if (form.status == "VALID" && this.validateImage) {
        ...
        this.UserQaService.editProjectManager(this.projectManager_edit).then(restData => {
          ...
          if(restData.code == 200) {
            ...
            snackBarRef.afterDismissed().subscribe(() => {
              this.router.navigate(["../../staffQA"], {relativeTo: this.route});
            });
          }
