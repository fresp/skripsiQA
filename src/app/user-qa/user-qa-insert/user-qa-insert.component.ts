...
@Component({
  selector: 'app-user-qa-insert',
  templateUrl: './user-qa-insert.component.html',
  styleUrls: ['./user-qa-insert.component.scss']
})
export class UserQaInsertComponent implements OnInit {
  ...
  onSubmit(form: NgForm){
    ...
    if (this.json_locstor !== null) {
      if (form.status == "VALID" && this.validateImage) {
        ...
        this.UserQaService.insertProjectManager(this.projectManager).then(restData => {
