...
@Component({
  selector: 'app-user-developer-insert',
  templateUrl: './user-developer-insert.component.html',
  styleUrls: ['./user-developer-insert.component.scss']
})
export class UserDeveloperInsertComponent implements OnInit {
  ...
  onSubmit(form: NgForm){
    ...
    if (this.json_locstor !== null) {
      if (form.status == "VALID" && this.validateImage) {
        ...
        this.UserDeveloperService.insertProjectManager(this.projectManager).then(restData => {
