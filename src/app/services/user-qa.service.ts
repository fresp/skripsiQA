...
export class UserQaService {
  ...
  listProjectManager(data: any): Promise<any> {
    return new Promise((resolve, reject) => {
        ...
        this.http.post(global.url_api + 'qa/get_list', body, options).subscribe(res => {
          resolve(res);
        }, err => {
          reject(err);
        })
  ...
  detailProjectManager(data: any): Promise<any> {
    return new Promise((resolve, reject) => {
        ...
        this.http.post(global.url_api + 'qa/detail', body, options).subscribe(res => {
          resolve(res);
        }, err => {
          reject(err);
        })
  ...
  insertProjectManager(data: any): Promise<any> {
    return new Promise((resolve, reject) => {
        ...
        this.http.post(global.url_api + 'qa/register', body, options).subscribe(res => {
          resolve(res);
        }, err => {
          reject(err);
        })
  ...
  editProjectManager(data: any): Promise<any> {
    return new Promise((resolve, reject) => {
        ...
        this.http.put(global.url_api + 'qa/', body, options).subscribe(res => {
          resolve(res);
        }, err => {
          reject(err);
        })
  ...
  deleteProjectManager(data: any): Promise<any> {
    return new Promise((resolve, reject) => {
        ...
        this.http.delete(global.url_api + 'qa', options).subscribe(res => {
          resolve(res);
        }, err => {
          reject(err);
        })
  ...
  importProjectManager(data: any): Promise<any> {
    return new Promise((resolve, reject) => {
        ...
        this.http.post(global.url_api + 'qa/import', body).subscribe(res => {
          resolve(res);
        }, err => {
          reject(err);
        })
