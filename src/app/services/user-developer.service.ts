...
export class UserDeveloperService {
  ...
  detailProjectManager(data: any): Promise<any> {
    return new Promise((resolve, reject) => {
        ...
        this.http.post(global.url_api + 'user/detail', body, options).subscribe(res => {
          resolve(res);
        }, err => {
          reject(err);
        })
  ...
  insertProjectManager(data: any): Promise<any> {
    return new Promise((resolve, reject) => {
        ...
        this.http.post(global.url_api + 'user/register', body, options).subscribe(res => {
          resolve(res);
        }, err => {
          reject(err);
        })
  ...
  editProjectManager(data: any): Promise<any> {
    return new Promise((resolve, reject) => {
        ...
        this.http.put(global.url_api + 'user/', body, options).subscribe(res => {
          resolve(res);
        }, err => {
          reject(err);
        })
  ...
  AllUser(data: any): Promise<any> {
    return new Promise((resolve, reject) => {
        ...
        this.http.post(global.url_api + 'user/topALL', body, options).subscribe(res => {
          resolve(res);
        }, err => {
          reject(err);
        })
